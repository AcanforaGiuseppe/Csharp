...
namespace LinqTutorial
{
    static class All
    {
        ...
        public static void Run()
        {
            ...
            // Please note that we can achieve the same result by using Any and reversing the condition
            var doAllPetsHaveNonEmptyName_WithAny = !(Data.Pets.Any(pet => string.IsNullOrEmpty(pet.Name)));
