...
namespace LinqTutorial.MethodSyntax
{
    static class ConcatUnion
    {
        ...
        public static void Run()
        {
            ...
            // In this case, Union will produce a collection of 3 elements because Hannibal from pets1 is not equal to Hannibal from pets2
            ...
            // We can, of course, chain the Concat and Union methods to merge more than one collection
