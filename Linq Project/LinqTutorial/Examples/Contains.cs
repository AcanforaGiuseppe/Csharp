...
namespace LinqTutorial
{
    static class Contains
    {
        ...
        public static void Run()
        {
            ...
            // The below will return false, because pets are compares by reference and we create a new reference here
            ...
            var containsAnthonyWithEqualityComparer = Data.Pets.Contains(new Pet(2, "Anthony", PetType.Cat, 2f), new PetEqualityByIdComparer());
            Console.WriteLine($"containsAnthonyWithEqualityComparer: " + $"{containsAnthonyWithEqualityComparer}");
        }
