...
namespace LinqTutorial.MethodSyntax
{
    static class ElementAt
    {
        ...
        public static void Run()
        {
            ...
            // The below line is not supported since Pets.Collection is an IEnumerable<Pet>, not an array
            ...
            // When there is no element under the index the default value for the type will be used - in this case null
