...
namespace LinqTutorial.MethodSyntax
{
    static class GroupBy
    {
        ...
        public static void Run()
        {
            ...
            // Let's say we want to create a Dictionary with PetType as the Key and sum of weights of Pets of this type
            ...
            // If we omitted the second param, the values in each group would simply be whole Pets objects, not weights

            // Now, let's group People by their names first letter and create a Dictionary where the first letter will be the key and those People Pets' Names will be the value
            ...
            // Now let's group Pets by the floor of their Weight and then let's create print all those groups with information about minimal and maximal weight in each group
