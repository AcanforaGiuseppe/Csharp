...
namespace LinqTutorial.MethodSyntax
{
    static class IntersectExcept
    {
        ...
        public static void Run()
        {
            ...
            // Except finds all the elements from the first collection, which are not present in the second collection
            ...
            // In this case, Intersect will produce empty collection because Hannibal from pets1 is not equal to Hannibal from pets2
            // Remember, they may look the same but they are two different objects with two different references
            ...
            // For example, people can donate money for given pets in an animal shelter and becone their virtual "owners"
