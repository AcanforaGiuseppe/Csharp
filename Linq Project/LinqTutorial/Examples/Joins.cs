...
namespace LinqTutorial.MethodSyntax
{
    static class Join
    {
        ...
        public static void Run()
        {
            ...
            // To print full information about the appointments the Join key will be the PetId, which is present in both collections
            ...
            // For inner joins it doesn't matter which collection is the "outer", and which is "inner" below we do the same as above, but we switch the order of the collections
            ...
            // Join supports joining 2 collections only, so we must create an intermediate collection of results that contain the result of joining two first collections
        ...
        public static class QuerySyntax
        {
            public static void Run()
            {
                ...
                // Now let's print something like this:
