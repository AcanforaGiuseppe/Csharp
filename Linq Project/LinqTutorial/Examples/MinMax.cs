...
namespace LinqTutorial
{
    static class MinMax
    {
        ...
        public static void Run()
        {
            ...
            // If we don't pass the selector when finding Min or Max of the collection that does not implement the IComparable interface an exception will be thrown
            //var minPet = Data.Pets.Min();

            // Min and Max will throw an exception if the collection is empty that's why the below code will not work
