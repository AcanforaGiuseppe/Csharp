...
namespace LinqTutorial
{
    static class OrderBy
    {
        ...
        {
            // OrderBy creates a copy of the collection, which is ordered by the given criteria
            ...
            // There are also overloaded versions of those methods accepting IComparer<T> as an input
