...
namespace LinqTutorial.MethodSyntax
{
    static class PrependAppend
    {
        ...
        public static void Run()
        {
            ...
            // Please note that a new collection is created the original collection is not modified
            ...
            // At first, we can select "Bad", "Medium" and "Good" grade, but after some time we want to also add "Terrible" and "Excellent" grades
