...
namespace LinqTutorial
{
    static class Skip
    {
        ...
        public static void Run()
        {
            ...
            // If we skip beyond the collection end the result collection will be empty
            ...
            // Let's say we want to pick all numbers except the largest and the smallest
            ...
            // Please note that once we're first done skipping all the next elements will be included, even if they meet the predicate in this case,
            // 11 and 12 will be included because we finished skipping when we processed the 154 number
            ...
            // For example, let's say we want to access all Pets except the 3rd, 4th and 5th pet in the collection
