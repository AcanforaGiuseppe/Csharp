...
namespace LinqTutorial
{
    static class Take
    {
        ...
        public static void Run()
        {
            ...
            // If we take more than collection size, whole collection will be returned
            ...
            // The collection will be empty because the first pet is lighter than 30 kilos, so while we process the first element the predicate will be false, so we will not Take even one element
