...
namespace LinqTutorial.MethodSyntax
{
    static class Zip
    {
        ...
        public static void Run()
        {
            ...
            // If the collections are of different lengths, the overflow will simply be ignored
            ...
            // We can use the result of the Zip function which is a collection of tuples
            ...
            // Let's say we have a list of Points on the map created by some application tracking activity like running or cycling, let's find the distances between particular Points
            var points = new[]
            {
                new Point(10, 10),
                new Point(10, 11),
            ...
            var distances = points.Zip(points.Skip(1), (point1, point2) => GetDistance(point1, point2));
